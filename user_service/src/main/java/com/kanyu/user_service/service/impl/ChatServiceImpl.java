...
import com.kanyu.user_service.dto.ChatContentDto;
import com.kanyu.user_service.dto.FriendShipDto;
import com.kanyu.user_service.dto.MessageDto;
import com.kanyu.user_service.entity.*;
import com.kanyu.user_service.mapper.ChatMapper;
import com.kanyu.user_service.service.*;
import com.kanyu.user_service.vo.GroupMessageVO;
import com.kanyu.user_service.vo.LatestMessageVO;
...
public class ChatServiceImpl extends ServiceImpl<ChatMapper, ChatContent> implements ChatService {
    ...
    public Result insertChat(ChatContent chatContent) {
        ...
        if (is_my_friend.getCode()==100007 || is_receiver_friend.getCode()==100007){ //对方不是你的好友，即对方被你删除了 或者没有加过对方为好友
            return Result.fail("对方不是你的好友微服务",100007);
